...
function Shop(props) {
  ...
  useEffect(() => {
    ...
    {
    	fetch("https://eardrum.ru:8890/shop/getLots", {
    	      method: "POST",
    	      headers: {
  ...
  function buy(id){
	...
	return (
      ...
      { arrayLots != null &&
    		<div>
					<Lot id={arrayLots[5]['id']} cost={arrayLots[5]['cost']} name={arrayLots[5]['name']} img={arrayLots[5]['img']} buy={buy}/>
					<Lot id={arrayLots[0]['id']} cost={arrayLots[0]['cost']} name={arrayLots[0]['name']} img={arrayLots[0]['img']} buy={buy}/>
					<Lot id={arrayLots[1]['id']} cost={arrayLots[1]['cost']} name={arrayLots[1]['name']} img={arrayLots[1]['img']} buy={buy}/>
					<Lot id={arrayLots[2]['id']} cost={arrayLots[2]['cost']} name={arrayLots[2]['name']} img={arrayLots[2]['img']} buy={buy}/>
					<Lot id={arrayLots[3]['id']} cost={arrayLots[3]['cost']} name={arrayLots[3]['name']} img={arrayLots[3]['img']} buy={buy}/>
					<Lot id={arrayLots[4]['id']} cost={arrayLots[4]['cost']} name={arrayLots[4]['name']} img={arrayLots[4]['img']} buy={buy}/>
				</div>
			}
			<button className="task" onClick={() => UpdatePage("BuyCategory")}>Купить игры по категориям</button>
